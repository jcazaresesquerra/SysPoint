...
public class ActualizarEmpleadoActivity extends AppCompatActivity {
    ...
    private void getData(){
        ...
        try {
            ...
            EmpleadoBean empleadoBean = empleadoDao.getEmpleadoByIdentificador(empladoGlobal);
    ...
    private boolean validaEmpleado() {
        ...
        EmpleadoBean bean = dao.getEmpleadoByIdentificador(ip_actualiza_empleado_id.getText().toString());
    ...
    private void enviaRolsServidor(String id){
     progressshow();
        ...
        final RolsJson rolsJson = new RolsJson();
        rolsJson.setRoles(listaRoles);

        Call<RolsJson> enviaRoles = ApiServices.getClientRestrofit().create(PointApi.class).saveRoles(rolsJson);
        String json = new Gson().toJson(rolsJson);
        Log.d("Roles", json);
        enviaRoles.enqueue(new Callback<RolsJson>() {
            @Override
    ...
    private void testLoadEmpleado(String id){
        ...
        EmpleadoJson empleadoRF = new EmpleadoJson();
        empleadoRF.setEmpleados(listEmpleados);
        String json = new Gson().toJson(empleadoRF);
        Log.d("SinEmpleados", json);

        Call<EmpleadoJson> loadEmleado = ApiServices.getClientRestrofit().create(PointApi.class).sendEmpleado(empleadoRF);

        loadEmleado.enqueue(new Callback<EmpleadoJson>() {
            @Override
