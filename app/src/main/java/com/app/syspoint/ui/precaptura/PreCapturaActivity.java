                ...
                dialogo.setTitle("Confirmar accion")
                        ...
                        .addButton(getString(R.string.confirmar_dialog), R.color.pdlg_color_white, R.color.green_800, new PrettyDialogCallback() {
                            ...
                            public void onClick() {
                                ...
                                final ClienteBean clienteBean = clientDao.getClientByAccount(idCuenta);
                                ...
                                final ClientesRutaBean clientesRutaBean =  ruteClientDao.getClienteByCuentaCliente(idCuenta);
