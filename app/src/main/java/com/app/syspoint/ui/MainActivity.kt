...
class MainActivity: BaseActivity() {
                ...
                if (connected) {
                    TokenInteractorImpl().executeGetToken(object :
                        ...
                        override fun onGetTokenError(
                            ...
                            showErrorDialog("Su aplicación necesita una actualización para funcionar correctamente en este dispositivo. Por favor, actualícela para continuar.")
    ...
    private fun setUpLogo() {
        ...
        navHeaderMainBinding.imageView?.let {
            it.setImageResource(R.drawable.logotenet)
        }
    }
