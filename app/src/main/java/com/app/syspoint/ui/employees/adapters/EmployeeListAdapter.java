...
public class EmployeeListAdapter extends RecyclerView.Adapter<EmployeeListAdapter.Holder> implements Filterable {
    ...
    public EmployeeListAdapter(List<EmpleadoBean> mData, OnItemClickListener onItemClickListener) {
        this.mData = mData;
    ...
    public interface OnItemClickListener{
        void onItemClick(EmpleadoBean empleadoBean);
    }
}
