package com.app.syspoint.templates;
...
public class ViewPDFActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ClienteBean clienteBean = clienteDao.getCliente(String.valueOf(clienteID));
        ...
        if (clienteBean != null){
            ...
            try {
                double saldoCliente = cobranzaDao.getTotalSaldoDocumentosCliente(clienteBean.getCuenta());
