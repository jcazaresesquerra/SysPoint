...
public class AdapterTipoVisita extends RecyclerView.Adapter<AdapterTipoVisita.Holder> {
    ...
    public AdapterTipoVisita(List<VisitType> mData, OnItemClickListener onItemClickListener) {
        this.mData = mData;
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        private void bind(VisitType item, OnItemClickListener onItemClickListener){
